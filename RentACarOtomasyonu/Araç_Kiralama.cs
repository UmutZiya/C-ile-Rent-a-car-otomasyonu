...
{
    class RentACarOtomasyonu
    {
        public SqlConnection baglanti = new SqlConnection("Data Source=DESKTOP-2SR3L8U;Initial Catalog=RentACarOtomasyonu;Integrated Security=True");
        DataTable tablo;
        ...
        public void Boş_Araçlar(ComboBox combo, string sorgu)
        {
            ...
            while (read.Read()) // kayıtlar okunduğu sürece işlem yapılsın
            {
