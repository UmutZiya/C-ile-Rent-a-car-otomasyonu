...
namespace RentACarOtomasyonu
{
    ...
    public partial class frmSözleşme : Form
    {
        ...
        {
            string sorgu2 = "select *from araç where plaka like '" + comboAraçlar.SelectedItem + "'";
            arac.Ücret_Hesapla(comboKiraŞekli, txtKira, sorgu2);
        }
        ...
        private void txtGün_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void txtTutar_SelectedIndexChanged(object sender, EventArgs e)
        {
